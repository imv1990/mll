//===- mll-tblgen.cpp - Top-Level TableGen implementation for MLL ---------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file contains the main function for MLL's TableGen.
//
//===----------------------------------------------------------------------===//
...
static bool mllTableGenMain(raw_ostream &os, RecordKeeper &records) {
...
int main(int argc, char **argv) {
  ...
  return TableGenMain(argv[0], &mllTableGenMain);
}